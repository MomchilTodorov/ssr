...
var fetchUsers = exports.fetchUsers = function fetchUsers() {
  return function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch, getState, api /*renamed from axiosInstance*/
    ) {
      var res;
...
exports.default = [_extends({}, _App2.default, { //no path added to App, meaning it will always be displayed on screen
...
var app = (0, _express2.default)(); /* CommonJS modules (not needed after setting up Webpack on the server)
